      ...
      <div className="my-order-container">
        ...
        <div className="OrderStatus">
          <div className="BarOrderStatus">
            ...
            <button className="w-[100px] h-8 px-4 py-1 bg-amber-400 rounded-md justify-center items-center gap-2.5 inline-flex" onClick={() => navigate("/MyOrderFinished")}>
              <div className="text-violet-900 text-base font-semibold font-['Poppins']]">Finished</div>
            </button>
          </div>
